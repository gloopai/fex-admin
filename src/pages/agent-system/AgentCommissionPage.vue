...
<template>
  <div class="space-y-6">
    <p class="text-sm text-white/55">
      账期佣金、结算状态与打款时间；各产品线<strong class="text-white/75">一级记佣比例</strong>由运营在<strong class="text-white/75">管理后台 → 代理管理</strong>为您配置，与下表及账单一致。
    </p>

    <div class="space-y-2">
      <h2 class="text-sm font-semibold text-white">我的记佣比例</h2>
      <p class="text-xs text-white/40">以下为当前登录代理账号在各产品线可享受的一级比例；未开通产品线不享受该线返佣。</p>
    ...
    <div class="space-y-2">
      <h2 class="text-sm font-semibold text-white">账期结算记录</h2>
      <div class="overflow-hidden rounded-xl border border-white/[0.06]">
        <div class="overflow-x-auto">
