...
export const whalesList = [
  ...
  {
    userId: 'user_whale_004',
    username: 'whale_delta',
    type: USER_TYPE.WHALE,
    totalPosition: 180000,
    longPosition: 120000,
    shortPosition: 60000,
    leverage: 30,
    pnl24h: 12400,
    pnlRate: 6.9,
    contracts: ['BTCUSDT', 'SOLUSDT'],
    riskLevel: RISK_LEVEL.HIGH
  },
  {
    userId: 'user_hf_002',
    ...
    pnl24h: 5600,
    pnlRate: 5.9,
    contracts: ['ETHUSDT', 'XRPUSDT', 'DOGEUSDT'],
    riskLevel: RISK_LEVEL.LOW
  },
  {
    userId: 'user_whale_005',
    username: 'whale_epsilon',
    type: USER_TYPE.WHALE,
    totalPosition: 290000,
    longPosition: 200000,
    shortPosition: 90000,
    leverage: 35,
    pnl24h: -15200,
    pnlRate: -5.2,
    contracts: ['ARBUSDT', 'OPUSDT'],
    riskLevel: RISK_LEVEL.CRITICAL
  },
  {
    userId: 'user_whale_006',
    username: 'whale_zeta',
    type: USER_TYPE.WHALE,
    totalPosition: 210000,
    longPosition: 110000,
    shortPosition: 100000,
    leverage: 22,
    pnl24h: 9800,
  ...
  {
    userId: 'user_whale_007',
    username: 'whale_theta',
    type: USER_TYPE.WHALE,
    totalPosition: 260000,
    longPosition: 150000,
    shortPosition: 110000,
    leverage: 28,
    pnl24h: 18900,
    pnlRate: 7.3,
    contracts: ['BTCUSDT', 'SOLUSDT', 'ARBUSDT'],
    riskLevel: RISK_LEVEL.HIGH
  },
  {
    userId: 'user_whale_008',
    username: 'whale_iota',
    type: USER_TYPE.WHALE,
    totalPosition: 195000,
    longPosition: 95000,
    shortPosition: 100000,
    leverage: 18,
    pnl24h: -8400,
    pnlRate: -4.3,
    contracts: ['ETHUSDT', 'XRPUSDT'],
    riskLevel: RISK_LEVEL.MEDIUM
  },
  {
    userId: 'user_hf_004',
    username: 'hf_market_maker',
    type: USER_TYPE.HIGH_FREQ,
    totalPosition: 110000,
    longPosition: 60000,
    shortPosition: 50000,
    leverage: 15,
    pnl24h: 11200,
    pnlRate: 10.2,
    contracts: ['BTCUSDT', 'ETHUSDT', 'SOLUSDT', 'DOGEUSDT'],
    riskLevel: RISK_LEVEL.MEDIUM
  },
  {
    userId: 'user_whale_009',
    username: 'whale_kappa',
    type: USER_TYPE.WHALE,
    totalPosition: 340000,
    longPosition: 250000,
    shortPosition: 90000,
    leverage: 40,
    pnl24h: -22000,
    pnlRate: -6.5,
    contracts: ['ARBUSDT', 'OPUSDT', 'MATICUSDT'],
    riskLevel: RISK_LEVEL.CRITICAL
  },
  {
    userId: 'user_whale_010',
    username: 'whale_lambda',
    type: USER_TYPE.WHALE,
    totalPosition: 175000,
    longPosition: 90000,
    shortPosition: 85000,
    leverage: 20,
    pnl24h: 7800,
    pnlRate: 4.5,
    contracts: ['DOGEUSDT', 'XRPUSDT'],
    riskLevel: RISK_LEVEL.MEDIUM
  },
  {
    userId: 'user_hf_005',
    username: 'hf_arbitrage',
    type: USER_TYPE.HIGH_FREQ,
    totalPosition: 68000,
    longPosition: 35000,
    shortPosition: 33000,
